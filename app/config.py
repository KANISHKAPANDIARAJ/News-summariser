...
class Config:
    ...
    # Database
    DATABASE_URL = os.getenv("DATABASE_URL", f"sqlite:///{ROOT_DIR / 'news_intelligence.db'}")
    ...
    DEFAULT_TRANSLATION_MODEL_TAMIL = os.getenv("DEFAULT_TRANSLATION_MODEL_TAMIL", "suriya7/English-to-Tamil")
    ...
    # Feature Flags
    ENABLE_MULTI_SOURCE = os.getenv("ENABLE_MULTI_SOURCE", "true").lower() in ("true", "1", "yes")
    ENABLE_COMPARISON = os.getenv("ENABLE_COMPARISON", "true").lower() in ("true", "1", "yes")
    ...
    ENABLE_BACKGROUND_JOBS = os.getenv("ENABLE_BACKGROUND_JOBS", "true").lower() in ("true", "1", "yes")
