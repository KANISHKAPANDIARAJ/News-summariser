...
SUPPORTED_LANGUAGES: Dict[str, Dict[str, str]] = {
    ...
    "fr": {"name": "French", "native": "Français", "model": "Helsinki-NLP/opus-mt-en-fr"},
    "de": {"name": "German", "native": "Deutsch", "model": "Helsinki-NLP/opus-mt-en-de"},
    "es": {"name": "Spanish", "native": "Español", "model": "Helsinki-NLP/opus-mt-en-es"},
    "it": {"name": "Italian", "native": "Italiano", "model": "Helsinki-NLP/opus-mt-en-it"},
    "pt": {"name": "Portuguese", "native": "Português", "model": "Helsinki-NLP/opus-mt-en-pt"},
    "ru": {"name": "Russian", "native": "Русский", "model": "Helsinki-NLP/opus-mt-en-ru"},
    "zh": {"name": "Chinese", "native": "中文", "model": "Helsinki-NLP/opus-mt-en-zh"},
    "ja": {"name": "Japanese", "native": "日本語", "model": "Helsinki-NLP/opus-mt-en-ja"},
    "ko": {"name": "Korean", "native": "한국어", "model": "Helsinki-NLP/opus-mt-en-ko"},
    "ar": {"name": "Arabic", "native": "العربية", "model": "Helsinki-NLP/opus-mt-en-ar"},
